...
This package extracts only paper metadata and bibliography references from an
input PDF. Citation-context extraction and alternate backend modes have been
removed.
