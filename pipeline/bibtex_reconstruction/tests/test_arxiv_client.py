...
def test_arxiv_published_work_prefers_doi_content_negotiation(monkeypatch):
    client = ArxivClient()
    doi_bibtex = "@article{published, doi={10.5555/example}}"
