...
MESSAGES = {
    "en": {
        "usage": "Mention me with exactly one BibTeX entry in a code block.",
        ...
        "expired": "This export request has expired. Mention me again with the BibTeX entry.",
        "wrong_user": "Only the user who submitted the BibTeX entry can choose its profile.",
        "unknown_profile": "That export profile is not available. Mention me again to refresh the list.",
    ...
    "ja": {
        "usage": "BibTeXエントリを1件だけコードブロックに入れてメンションしてください。",
        ...
        "expired": "この出力リクエストは期限切れです。BibTeXエントリを付けて再度メンションしてください。",
        "wrong_user": "プロファイルを選択できるのはBibTeXエントリを送信したユーザーだけです。",
        "unknown_profile": "その出力プロファイルは利用できません。再度メンションして一覧を更新してください。",
