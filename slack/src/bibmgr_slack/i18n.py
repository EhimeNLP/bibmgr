...
MESSAGES = {
    "en": {
        ...
        "invalid_syntax": "The code block is not valid BibTeX, so it cannot be exported.",
        "syntax_findings": "Syntax findings ({count}):",
    ...
    "ja": {
        ...
        "invalid_syntax": "コードブロックが正しいBibTeXではないため、出力できません。",
        "syntax_findings": "構文上の問題が{count}件あります：",
...
JA_DIAGNOSTIC_DESCRIPTIONS = {
    ...
    "BIB-SYNTAX-005": "引用符より波括弧で囲んだフィールド値が推奨されます。",
    ...
    "BIB-SYNTAX-107": "フィールド値の後にカンマまたはエントリの閉じ括弧が必要です。",
