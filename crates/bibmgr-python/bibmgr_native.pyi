...
def validate_for_registration(source: str, policy: str = "archive") -> RegistrationValidation: ...
def canonicalize_for_storage(source: str, policy: str = "archive") -> RegistrationValidation: ...
